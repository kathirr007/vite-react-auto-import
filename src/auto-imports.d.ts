...
declare global {
  ...
  const BaseTest: typeof import('@/components/base/test.tsx')['test']
  const BaseXxx: typeof import('@/components/base/xxx.tsx')['xxx']
  ...
  const MainLayout: typeof import('./layouts/MainLayout')['default']
  const NavLink: typeof import('react-router-dom')['NavLink']
  const Navigate: typeof import('react-router-dom')['Navigate']
  const Outlet: typeof import('react-router-dom')['Outlet']
  const PageA: typeof import('./views/PageA')['default']
  const PageB: typeof import('./views/PageB')['default']
  ...
  const useInput: typeof import('./hooks/useInput')['useInput']
...
declare global {
  // @ts-ignore
  export type { TypeA } from './views/PageA'
  import('./views/PageA')
  // @ts-ignore
  export type { TypeB } from './views/PageB'
  import('./views/PageB')
}
